...
class LogManager
{
    ...
    return (preg_match('/[\'^£$%&*()}{#~?>
  <>,|=+¬]/',$word)); } /*function which returns true if the url begins by ./uploads/"username"/ */ function test_path($url,$username){ $strUrl="./uploads/".$username."/" ; $urlLen=strlen($strUrl); if(strncmp ($strUrl,$url, $urlLen )==0){ return true; }else{
    return false; } } }